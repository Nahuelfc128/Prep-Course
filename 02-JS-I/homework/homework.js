...
function sonIguales(x, y){        //   sonIguales (10, 12)
...
function tienenMismaLongitud(str1, str2) { // - - - - - - - - >  tienenMismaLongitud( 'Hola', 'Nahuel')
  // Devuelve "true" si las dos strings tienen la misma longitud                       4        6
  // De lo contrario, devuelve "false"
  // Tu código:
